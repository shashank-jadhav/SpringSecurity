...
import com.shashank.auth.custom.CustomUsernamePasswordAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests().antMatchers("/", "/login", "/logout" , "/swagger-ui.html").permitAll().and()
	...
	public CustomUsernamePasswordAuthenticationFilter authenticationFilter() throws Exception {
		...
		authFilter.setAuthenticationSuccessHandler(new AuthenticationSuccessHandler() {
			...
			public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
				...
				log.info("############ Inside SecurityConfiguration#onAuthenticationSuccess method ########");
		...
		authFilter.setAuthenticationFailureHandler(new AuthenticationFailureHandler() {
			...
			public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
				...
				log.info("############ Inside SecurityConfiguration#onAuthenticationFailure method ########");
